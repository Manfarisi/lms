...
const AddCourse = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      if (!image) {
        toast.error("Thumbail Not Selected");
      }
      ...
      >
        ...
        <div>
          {chapters.map((chapter, chapterIndex) => (
            <div key={chapterIndex} className="bg-white border rounded-lg mb4">
          ...
          <div
            className="flex justify-center items-center bg-yellow-200 p-2 rounded-lg mt-5 cursor-pointer"

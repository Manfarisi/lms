      ...
      <div className="space-y-5">
        <div className="flex flex-wrap gap-5 items-center">
          ...
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
            <img src={assets.patients_icon} alt="patien" />
            <div>
          ...
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
            <img src={assets.appointments_icon} alt="patien" />
            <div>
              <p className="text-2x1 font-medium text-gray-600">
          ...
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
            <img src={assets.earning_icon} alt="patien" />
            <div>
        ...
        <div>
          ...
          <tr>
            ...
            <th className="px-4 py-3 font-semibold">Couse Title</th>
          </tr>
          </thead>

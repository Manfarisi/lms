...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full pt-20 md:pt-36 px-7 md:px-0 text-center bg-gradient-to-b from-yellow-100/70">
      <h1 className="text-home-heading-small md:text-home-heading-large font-bold text-gray-800 max-w-3xl mx-auto">
        Empower your future with the courses designed to 
        <span className="text-yellow-600"> fit your choice.</span>
      </h1>
